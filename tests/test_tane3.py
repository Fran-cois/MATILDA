...
# Test TANE with command directly from the code
...
classPath = "de.metanome.algorithms.tane.TaneAlgorithm"  # Classe correcte trouvée dans le JAR
rule_type = "fds"
...
# Construction de la commande comme dans tane.py
cmd_string = (
