...
algorithm_name = "DFD"
classPath = "de.metanome.algorithms.dfd.dfdMetanome.DFDMetanome"
rule_type = "fds"
...
dfd_jar = f"{jar_path}dfd-0.0.2-SNAPSHOT.jar"
...
if not os.path.exists(dfd_jar):
    logging.error(f"Fichier JAR manquant: {dfd_jar}")
    exit(1)

# Construction de la commande
cmd_string = (
    f"""java -cp {metanome_cli_jar}:{dfd_jar} """
